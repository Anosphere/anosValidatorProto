...
const (
	...
	TxType_TX_TYPE_ADD_ATTESTOR    TxType = 3
	TxType_TX_TYPE_REMOVE_ATTESTOR TxType = 4
)
...
var (
	TxType_name = map[int32]string{
		...
		1: "TX_TYPE_SEND",
		2: "TX_TYPE_RECEIVE",
		3: "TX_TYPE_ADD_ATTESTOR",
		4: "TX_TYPE_REMOVE_ATTESTOR",
	}
	TxType_value = map[string]int32{
		"TX_TYPE_UNSPECIFIED":     0,
		"TX_TYPE_SEND":            1,
		"TX_TYPE_RECEIVE":         2,
		"TX_TYPE_ADD_ATTESTOR":    3,
		"TX_TYPE_REMOVE_ATTESTOR": 4,
	}
)
...
type TxBodyAddAttestor struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Pubkey        *Pub32                 `protobuf:"bytes,1,opt,name=pubkey,proto3" json:"pubkey,omitempty"` // ed25519 pubkey being added (32 bytes)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TxBodyAddAttestor) Reset() {
	*x = TxBodyAddAttestor{}
...
func (x *TxBodyAddAttestor) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxBodyAddAttestor) ProtoMessage() {}

func (x *TxBodyAddAttestor) ProtoReflect() protoreflect.Message {
	mi := &file_proto_anos_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxBodyAddAttestor.ProtoReflect.Descriptor instead.
func (*TxBodyAddAttestor) Descriptor() ([]byte, []int) {
	return file_proto_anos_proto_rawDescGZIP(), []int{6}
}

func (x *TxBodyAddAttestor) GetPubkey() *Pub32 {
	if x != nil {
		return x.Pubkey
	}
	return nil
...
type TxBodyRemoveAttestor struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Pubkey        *Pub32                 `protobuf:"bytes,1,opt,name=pubkey,proto3" json:"pubkey,omitempty"` // ed25519 pubkey being removed (32 bytes)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TxBodyRemoveAttestor) Reset() {
	*x = TxBodyRemoveAttestor{}
	mi := &file_proto_anos_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TxBodyRemoveAttestor) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxBodyRemoveAttestor) ProtoMessage() {}

func (x *TxBodyRemoveAttestor) ProtoReflect() protoreflect.Message {
	mi := &file_proto_anos_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxBodyRemoveAttestor.ProtoReflect.Descriptor instead.
func (*TxBodyRemoveAttestor) Descriptor() ([]byte, []int) {
	return file_proto_anos_proto_rawDescGZIP(), []int{7}
}

func (x *TxBodyRemoveAttestor) GetPubkey() *Pub32 {
	if x != nil {
		return x.Pubkey
	}
	return nil
...
type MultiSig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Pubkeys       []*Pub32               `protobuf:"bytes,1,rep,name=pubkeys,proto3" json:"pubkeys,omitempty"`
	Sigs          []*Sig64               `protobuf:"bytes,2,rep,name=sigs,proto3" json:"sigs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MultiSig) GetPubkeys() []*Pub32 {
	if x != nil {
		return x.Pubkeys
	}
	return nil
...
func (x *SignerSet) GetPubkeys() []*Pub32 {
	if x != nil {
		return x.Pubkeys
	}
	return nil
...
type GetSignerSetResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetSignerSetResponse) Reset() {
	*x = GetSignerSetResponse{}
	mi := &file_proto_anos_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetSignerSetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSignerSetResponse) ProtoMessage() {}

func (x *GetSignerSetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_anos_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSignerSetResponse.ProtoReflect.Descriptor instead.
func (*GetSignerSetResponse) Descriptor() ([]byte, []int) {
	return file_proto_anos_proto_rawDescGZIP(), []int{10}
}

func (x *GetSignerSetResponse) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
func (x *GetSignerSetResponse) GetSignerSet() *SignerSet {
	if x != nil {
		return x.SignerSet
	}
	return nil
...
func (x *GetSignerSetResponse) GetError() *ApiError {
	if x != nil {
		return x.Error
	}
	return nil
...
type TxSignable struct {
	...
	//	*TxSignable_Send
	//	*TxSignable_Receive
	//	*TxSignable_AddAttestor
	//	*TxSignable_RemoveAttestor
...
func (x *TxSignable) GetAddAttestor() *TxBodyAddAttestor {
	if x != nil {
		if x, ok := x.Body.(*TxSignable_AddAttestor); ok {
			return x.AddAttestor
		}
	}
	return nil
}

func (x *TxSignable) GetRemoveAttestor() *TxBodyRemoveAttestor {
	if x != nil {
		if x, ok := x.Body.(*TxSignable_RemoveAttestor); ok {
			return x.RemoveAttestor
		}
	}
	return nil
}
...
type TxSignable_AddAttestor struct {
	AddAttestor *TxBodyAddAttestor `protobuf:"bytes,12,opt,name=add_attestor,json=addAttestor,proto3,oneof"`
}

type TxSignable_RemoveAttestor struct {
	RemoveAttestor *TxBodyRemoveAttestor `protobuf:"bytes,13,opt,name=remove_attestor,json=removeAttestor,proto3,oneof"`
}
...
func (*TxSignable_AddAttestor) isTxSignable_Body() {}

func (*TxSignable_RemoveAttestor) isTxSignable_Body() {}
...
type Tx struct {
	...
	MultiSig      *MultiSig `protobuf:"bytes,21,opt,name=multi_sig,json=multiSig,proto3" json:"multi_sig,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Tx) GetAddAttestor() *TxBodyAddAttestor {
	if x != nil {
		if x, ok := x.Body.(*Tx_AddAttestor); ok {
			return x.AddAttestor
		}
	}
	return nil
...
func (x *Tx) GetRemoveAttestor() *TxBodyRemoveAttestor {
	if x != nil {
		if x, ok := x.Body.(*Tx_RemoveAttestor); ok {
			return x.RemoveAttestor
		}
	}
	return nil
...
func (x *Tx) GetMultiSig() *MultiSig {
	if x != nil {
		return x.MultiSig
	}
	return nil
...
type Tx_AddAttestor struct {
	AddAttestor *TxBodyAddAttestor `protobuf:"bytes,12,opt,name=add_attestor,json=addAttestor,proto3,oneof"`
}

type Tx_RemoveAttestor struct {
	RemoveAttestor *TxBodyRemoveAttestor `protobuf:"bytes,13,opt,name=remove_attestor,json=removeAttestor,proto3,oneof"`
}
...
func (*Tx_AddAttestor) isTx_Body() {}

func (*Tx_RemoveAttestor) isTx_Body() {}
...
const file_proto_anos_proto_rawDesc = "" +
	...
	"\raccount_class\x18\x05 \x01(\x0e2\x15.anos.v2.AccountClassR\faccountClass\"\xfc\x01\n" +
	"\rTxBodyReceive\x124\n" +
	...
	"\x15transfer_unlock_epoch\x18\x04 \x01(\x04R\x13transferUnlockEpoch\";\n" +
	"\x11TxBodyAddAttestor\x12&\n" +
	"\x06pubkey\x18\x01 \x01(\v2\x0e.anos.v2.Pub32R\x06pubkey\">\n" +
	"\x14TxBodyRemoveAttestor\x12&\n" +
	"\x06pubkey\x18\x01 \x01(\v2\x0e.anos.v2.Pub32R\x06pubkey\"X\n" +
	"\bMultiSig\x12(\n" +
	"\apubkeys\x18\x01 \x03(\v2\x0e.anos.v2.Pub32R\apubkeys\x12\"\n" +
	"\x04sigs\x18\x02 \x03(\v2\x0e.anos.v2.Sig64R\x04sigs\"S\n" +
	"\tSignerSet\x12(\n" +
	"\apubkeys\x18\x01 \x03(\v2\x0e.anos.v2.Pub32R\apubkeys\x12\x1c\n" +
	"\tthreshold\x18\x02 \x01(\rR\tthreshold\"\x82\x01\n" +
	"\x14GetSignerSetResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x121\n" +
	"\n" +
	"signer_set\x18\x02 \x01(\v2\x12.anos.v2.SignerSetR\tsignerSet\x12'\n" +
	"\x05error\x18\x03 \x01(\v2\x11.anos.v2.ApiErrorR\x05error\"\x88\x03\n" +
	"\n" +
	"TxSignable\x12#\n" +
	...
	"\fadd_attestor\x18\f \x01(\v2\x1a.anos.v2.TxBodyAddAttestorH\x00R\vaddAttestor\x12H\n" +
	"\x0fremove_attestor\x18\r \x01(\v2\x1d.anos.v2.TxBodyRemoveAttestorH\x00R\x0eremoveAttestorB\x06\n" +
	"\x04body\"\xd2\x03\n" +
	"\x02Tx\x12#\n" +
	"\x04type\x18\x01 \x01(\x0e2\x0f.anos.v2.TxTypeR\x04type\x12,\n" +
	"\aaccount\x18\x02 \x01(\v2\x12.anos.v2.AccountIdR\aaccount\x12#\n" +
	...
	"\areceive\x18\v \x01(\v2\x16.anos.v2.TxBodyReceiveH\x00R\areceive\x12?\n" +
	"\fadd_attestor\x18\f \x01(\v2\x1a.anos.v2.TxBodyAddAttestorH\x00R\vaddAttestor\x12H\n" +
	"\x0fremove_attestor\x18\r \x01(\v2\x1d.anos.v2.TxBodyRemoveAttestorH\x00R\x0eremoveAttestor\x12 \n" +
	"\x03sig\x18\x14 \x01(\v2\x0e.anos.v2.Sig64R\x03sig\x12.\n" +
	"\tmulti_sig\x18\x15 \x01(\v2\x11.anos.v2.MultiSigR\bmultiSigB\x06\n" +
	"\x04body\"\xee\x02\n" +
	"\n" +
	"Receivable\x12\x1f\n" +
	...
	"\x13required_dest_class\x18\t \x01(\x0e2\x15.anos.v2.AccountClassR\x11requiredDestClass\"\xc0\x01\n" +
	...
	"\freached_have\x18\x02 \x01(\bR\vreachedHave*\x7f\n" +
	"\x06TxType\x12\x17\n" +
	"\x13TX_TYPE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fTX_TYPE_SEND\x10\x01\x12\x13\n" +
	"\x0fTX_TYPE_RECEIVE\x10\x02\x12\x18\n" +
	"\x14TX_TYPE_ADD_ATTESTOR\x10\x03\x12\x1b\n" +
	"\x17TX_TYPE_REMOVE_ATTESTOR\x10\x04*\xb7\x01\n" +
	...
	"\x16ACCOUNT_CLASS_TRANSFER\x10\x05B\x18Z\x16anos/internal/proto;pbb\x06proto3"
...
var file_proto_anos_proto_goTypes = []any{
	...
	(*TxBodyAddAttestor)(nil),        // 8: anos.v2.TxBodyAddAttestor
	(*TxBodyRemoveAttestor)(nil),     // 9: anos.v2.TxBodyRemoveAttestor
...
var file_proto_anos_proto_depIdxs = []int32{
	...
	5,  // 5: anos.v2.TxBodyReceive.transfer_destination:type_name -> anos.v2.AccountId
	4,  // 6: anos.v2.TxBodyAddAttestor.pubkey:type_name -> anos.v2.Pub32
	4,  // 7: anos.v2.TxBodyRemoveAttestor.pubkey:type_name -> anos.v2.Pub32
	4,  // 8: anos.v2.MultiSig.pubkeys:type_name -> anos.v2.Pub32
	3,  // 9: anos.v2.MultiSig.sigs:type_name -> anos.v2.Sig64
	4,  // 10: anos.v2.SignerSet.pubkeys:type_name -> anos.v2.Pub32
	11, // 11: anos.v2.GetSignerSetResponse.signer_set:type_name -> anos.v2.SignerSet
	17, // 12: anos.v2.GetSignerSetResponse.error:type_name -> anos.v2.ApiError
	0,  // 13: anos.v2.TxSignable.type:type_name -> anos.v2.TxType
	5,  // 14: anos.v2.TxSignable.account:type_name -> anos.v2.AccountId
	2,  // 15: anos.v2.TxSignable.prev:type_name -> anos.v2.Hash32
	6,  // 16: anos.v2.TxSignable.send:type_name -> anos.v2.TxBodySend
	7,  // 17: anos.v2.TxSignable.receive:type_name -> anos.v2.TxBodyReceive
	8,  // 18: anos.v2.TxSignable.add_attestor:type_name -> anos.v2.TxBodyAddAttestor
	9,  // 19: anos.v2.TxSignable.remove_attestor:type_name -> anos.v2.TxBodyRemoveAttestor
	0,  // 20: anos.v2.Tx.type:type_name -> anos.v2.TxType
	5,  // 21: anos.v2.Tx.account:type_name -> anos.v2.AccountId
	2,  // 22: anos.v2.Tx.prev:type_name -> anos.v2.Hash32
	6,  // 23: anos.v2.Tx.send:type_name -> anos.v2.TxBodySend
	7,  // 24: anos.v2.Tx.receive:type_name -> anos.v2.TxBodyReceive
	8,  // 25: anos.v2.Tx.add_attestor:type_name -> anos.v2.TxBodyAddAttestor
	9,  // 26: anos.v2.Tx.remove_attestor:type_name -> anos.v2.TxBodyRemoveAttestor
	3,  // 27: anos.v2.Tx.sig:type_name -> anos.v2.Sig64
	10, // 28: anos.v2.Tx.multi_sig:type_name -> anos.v2.MultiSig
	2,  // 29: anos.v2.Receivable.id:type_name -> anos.v2.Hash32
	5,  // 30: anos.v2.Receivable.from:type_name -> anos.v2.AccountId
	5,  // 31: anos.v2.Receivable.to:type_name -> anos.v2.AccountId
	2,  // 32: anos.v2.Receivable.created_by_tx:type_name -> anos.v2.Hash32
	2,  // 33: anos.v2.Receivable.claimed_by_tx:type_name -> anos.v2.Hash32
	1,  // 34: anos.v2.Receivable.required_dest_class:type_name -> anos.v2.AccountClass
	2,  // 35: anos.v2.EpochRecord.accepted_txs:type_name -> anos.v2.Hash32
	2,  // 36: anos.v2.EpochRecord.state_root:type_name -> anos.v2.Hash32
	2,  // 37: anos.v2.EpochRecord.prev_epoch_hash:type_name -> anos.v2.Hash32
	14, // 38: anos.v2.SubmitTxRequest.tx:type_name -> anos.v2.Tx
	2,  // 39: anos.v2.SubmitTxResponse.txid:type_name -> anos.v2.Hash32
	17, // 40: anos.v2.SubmitTxResponse.error:type_name -> anos.v2.ApiError
...
func file_proto_anos_proto_init() {
	...
	file_proto_anos_proto_msgTypes[11].OneofWrappers = []any{
		(*TxSignable_Send)(nil),
		(*TxSignable_Receive)(nil),
		(*TxSignable_AddAttestor)(nil),
		(*TxSignable_RemoveAttestor)(nil),
	}
	file_proto_anos_proto_msgTypes[12].OneofWrappers = []any{
		(*Tx_Send)(nil),
		(*Tx_Receive)(nil),
		(*Tx_AddAttestor)(nil),
		(*Tx_RemoveAttestor)(nil),
	}
	type x struct{}
